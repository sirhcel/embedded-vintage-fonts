...
const BASELINE: usize = FONT_12X16.baseline as usize;
const BASELINE_POINT: Point = Point::new(0, BASELINE as i32);
const WIDTH: usize = FONT_12X16.character_size.width as usize;
const HEIGHT: usize = FONT_12X16.character_size.height as usize;
const HELLO_WORLD: &str = "Hello World!";

#[test]
fn text_dimensions() {
    let style = MonoTextStyle::new(&FONT_12X16, BinaryColor::On);
