...
mod common;
use embedded_vintage_fonts::FONT_6X6;

#[test]
fn text_dimensions() {
    common::check_text_dimensions(&FONT_6X6);
}

#[test]
fn text_corners() {
    common::check_text_corners(&FONT_6X6);
}
...
// This font only supports ASCII plus some characters from Latin 1/ISO 8859-1
// and Latin 15/ISO 8859-15 and so there is no test case for Latin 1.
